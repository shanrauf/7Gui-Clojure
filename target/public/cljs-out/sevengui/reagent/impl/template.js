...
var G__13176 = o;
goog.object.set(G__13176,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__13177__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__13177 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__13178__i = 0, G__13178__a = new Array(arguments.length -  0);
while (G__13178__i < G__13178__a.length) {G__13178__a[G__13178__i] = arguments[G__13178__i + 0]; ++G__13178__i;}
  args = new cljs.core.IndexedSeq(G__13178__a,0,null);
} 
...
var args = cljs.core.seq(arglist__13179);
...
var G__13180 = o;
goog.object.set(G__13180,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__13182__i < G__13182__a.length) {G__13182__a[G__13182__i] = arguments[G__13182__i + 0]; ++G__13182__i;}
  args = new cljs.core.IndexedSeq(G__13182__a,0,null);
} 
...
var G__13184 = props;
var G__13184__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13184,cljs.core.cst$kw$id,id):G__13184);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13184__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4223__auto__ = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__13185 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13185,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__13185;
}
})(),id_class);
...
var G__13186 = (cljs.core.count(argv) - first_child);
switch (G__13186) {
case (0):
...
break;
case (1):
var G__13187 = component;
var G__13188 = jsprops;
var G__13189 = reagent.impl.protocols.as_element(this$,cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return reagent.impl.template.global$module$react.createElement(G__13187,G__13188,G__13189);
...
var vec__13191 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13191,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13191,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13191,(2),null);
...
var temp__5757__auto___13194 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___13194 == null)){
} else {
var key_13195 = temp__5757__auto___13194;
(jsprops.key = key_13195);
}
...
var temp__5757__auto___13198 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___13198 == null)){
} else {
var key_13199 = temp__5757__auto___13198;
(jsprops.key = key_13199);
}

var G__13196 = reagent.impl.component.functional_render_fn(compiler,tag);
var G__13197 = jsprops;
return reagent.impl.template.global$module$react.createElement(G__13196,G__13197);
});
/**
...
var temp__5757__auto___13200 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___13200 == null)){
} else {
var key_13201 = temp__5757__auto___13200;
(jsprops.key = key_13201);
}
...
var temp__5757__auto___13202 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___13202 == null)){
} else {
var key_13203 = temp__5757__auto___13202;
(jsprops.key = key_13203);
}
...
var temp__5757__auto___13204 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___13204 == null)){
} else {
var key_13205 = temp__5757__auto___13204;
(jsprops.key = key_13205);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13206_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__13206_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__13207 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13207,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13207,(1),null);
...
break;
default:
var G__13212 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__13213 = compiler;
v = G__13212;
compiler = G__13213;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template13217 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template13217 = (function (opts,id,fn_to_element,meta13218){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template13217.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13219,meta13218__$1){
var self__ = this;
var _13219__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template13217(self__.opts,self__.id,self__.fn_to_element,meta13218__$1));
}));

(reagent.impl.template.t_reagent$impl$template13217.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13219){
var self__ = this;
var _13219__$1 = this;
return self__.meta13218;
}));

(reagent.impl.template.t_reagent$impl$template13217.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template13217.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template13217.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template13217.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template13217.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$opts,cljs.core.cst$sym$id,cljs.core.cst$sym$fn_DASH_to_DASH_element,cljs.core.cst$sym$meta13218], null);
}));

(reagent.impl.template.t_reagent$impl$template13217.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template13217.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template13217");

(reagent.impl.template.t_reagent$impl$template13217.cljs$lang$ctorPrWriter = (function (this__4461__auto__,writer__4462__auto__,opt__4463__auto__){
return cljs.core._write(writer__4462__auto__,"reagent.impl.template/t_reagent$impl$template13217");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template13217.
 */
reagent.impl.template.__GT_t_reagent$impl$template13217 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template13217(opts__$1,id__$1,fn_to_element__$1,meta13218){
return (new reagent.impl.template.t_reagent$impl$template13217(opts__$1,id__$1,fn_to_element__$1,meta13218));
});

}

return (new reagent.impl.template.t_reagent$impl$template13217(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
